...
* Problem 7 will be covered Tuesday. 
...
* Problem 12 will be addressed on Tuesday. 
...
<a name="p14" href="#p14" onclick="toggle_visibility('p13div1');">14 - Click to show</a>
...
public int balanceHeightTest(Node n)
{
  ...
  int leftBalanced = balanceHeightTest(n.left);
  int rightBalanced = balanceHeightTest(n.right);
